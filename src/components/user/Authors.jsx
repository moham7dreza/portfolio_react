...
const AuthorsList = ({authors}) => {
    return (
        <>
            {
                authors.map((author) => (
                    <div key={author.id} className="grid sm:flex sm:items-center gap-y-3 gap-x-4">
                        <Link to={`/blogs/author/${author.id}/posts`} title="show author's post">
                            <img className="rounded-lg size-20"
                        ...
                        <div className="sm:flex sm:flex-col sm:h-full">
                            ...
                            <div className="mt-2 sm:mt-auto space-x-2.5">
                                <a className="inline-flex justify-center items-center text-gray-500 rounded-full hover:text-gray-800 dark:text-neutral-500 dark:hover:text-neutral-200"
                                   href="#">
